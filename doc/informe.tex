...
El Web Server implementado es iterativo, es decir, sólo atiende de a un HTTP Request.
 Se decidió hacerlo de esta manera ya que no se supone que sea un servicio 
...
\begin{itemize}
  ...
  limitado, debido a la implementación de conexiones persistentes. {\Huge{Sin
  embargo, al ser completamente configurable, puede incrementarse tanto como se
  desee!}}
