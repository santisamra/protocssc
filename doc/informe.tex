...
\emph{sockets} en clases específicas del proxy. Las conexiones, así como la
...
buscar el \emph{favicon} de la misma. Inclusive, el navegador reintentaba varias
veces ir a buscar el \emph{favicon}. Debido a esto, se concluyó que en
...
\subsection{Servidores y clientes que hablan mal el protocolo}
...
\emph{content-type} declarado en la respuesta era \emph{image/jpeg}, el servidor
en realidad estaba devolviendo un XML.\\

Otro problema consistió en que algunos navegadores como \emph{Mozilla Firefox}
envían \emph{headers} no descriptos por el RFC 2616, como
\emph{Proxy-Connection} en vez de \emph{Connection}. Se debió lidiar con estas 
...
Fue interesante el hecho de tener la posibilidad de interceptar la información
...
mencionadas en las posibles extensiones.\\
